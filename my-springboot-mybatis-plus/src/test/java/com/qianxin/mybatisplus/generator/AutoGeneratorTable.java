package com.qianxin.mybatisplus.generator;
...
public class AutoGeneratorTable extends ConfigGeneratorTest {
    ...
    public static void main( String[] args ) {
        ...
        cg.setDbUrl("jdbc:mysql://39.106.36.243:3306/test?characterEncoding=utf8");
		 ...
		 * 指定生成表名（默认，所有表）
		 */
        cg.setTableNames(new String[]{"t_charger_order","bs_charger"});
