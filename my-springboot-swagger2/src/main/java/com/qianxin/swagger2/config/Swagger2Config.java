package com.qianxin.swagger2.config;
...
public class Swagger2Config {
	...
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2)
		           ...
		           .apis(RequestHandlerSelectors.basePackage("com.qianxin"))
		           .paths(PathSelectors.any())
		           .build();
	}
	
	private ApiInfo apiInfo() {
		Contact contact = new Contact("Qinhua_Zhao", "http://localhost:8080/swagger-ui.html", "Qinhua_Zhao@outlook.com");
